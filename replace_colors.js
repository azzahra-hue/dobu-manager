...
files.forEach(file => {
  ...
  content = content
    ...
    .replace(/hover:bg-orange-50/g, 'hover:bg-sky-50')
    ...
    .replace(/bg-sky-100 text-sky-700 rounded-full/g, 'bg-amber-100 text-amber-700 rounded-full')
    .replace(/bg-sky-100 text-sky-700 uppercase/g, 'bg-amber-100 text-amber-700 uppercase')
